...
" Python stuff
" try/excepts
hi Exception     ctermfg=116 ctermbg=0 cterm=NONE

"hi clear -- no settings --
hi Union     ctermfg=254 ctermbg=9 cterm=NONE
hi TabLineFill     ctermfg=244 ctermbg=9 cterm=underline
hi Question     ctermfg=238 ctermbg=9 cterm=bold
hi WarningMsg     ctermfg=232 ctermbg=9 cterm=bold
hi VisualNOS     ctermfg=226 ctermbg=9 cterm=bold
hi CursorColumn     ctermfg=118 ctermbg=9 cterm=NONE
hi Define     ctermfg=161 ctermbg=9 cterm=NONE
